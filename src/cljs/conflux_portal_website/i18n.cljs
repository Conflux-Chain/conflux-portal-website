...
(def dicts
  {:en {:home-page/description "ConfluxPortal is an extension to access Conflux Network Ecosystem DApps from your preferred browser. Available now: Google Chrome, Firefox, QQBrowser, 360Browser, SogouBrowser."
